  ...
  useEffect(() => {
    ...
    return (
      <div name="quotes" className='w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white'>
        ...
        <div>
        <button className='text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-50' onClick={handleButtonClick}>Generate New Quote</button>
      </div>
        </div>
      </div>
    )
